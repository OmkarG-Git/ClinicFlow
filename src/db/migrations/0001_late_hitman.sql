...
--> statement-breakpoint
ALTER TABLE "clinics" ALTER COLUMN "email" SET NOT NULL;--> statement-breakpoint
...
ALTER TABLE "clinics" ADD COLUMN "working_days" text[];--> statement-breakpoint
ALTER TABLE "clinics" ADD COLUMN "opening_time" time;--> statement-breakpoint
ALTER TABLE "clinics" ADD COLUMN "closing_time" time;--> statement-breakpoint
ALTER TABLE "clinics" ADD COLUMN "gst_number" text;--> statement-breakpoint
